...
//Mudanças:
// Nova formatação da matriz (ainda não implementada, porém salva para críticas);
// Linha 248 a 263: Aumento no número de tentativas após finalização dos espaços (5 para 10 tentativas);
// Linha 353 a 359: Alteração na mensagem final ao usuário, dependendo de seu desempenho no jogo;
// Linha 248 a 263: Retirada de mensagens printf na void decisaoFinal;